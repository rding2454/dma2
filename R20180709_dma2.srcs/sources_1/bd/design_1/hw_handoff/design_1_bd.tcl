...
proc create_root_design { parentCell } {
  ...
  set number [ create_bd_port -dir O -from 7 -to 0 number ]
  ...
  connect_bd_net -net SW_1 [get_bd_ports SW] [get_bd_pins cycle_counter_0/SW]
  connect_bd_net -net axi_dma_0_m_axis_mm2s_tdata [get_bd_pins axi_dma_0/m_axis_mm2s_tdata] [get_bd_pins axis_data_fifo_0/s_axis_tdata]
  ...
  connect_bd_net -net axi_dma_0_s_axis_s2mm_tready [get_bd_pins axi_dma_0/s_axis_s2mm_tready] [get_bd_pins axis_data_fifo_0/m_axis_tready] [get_bd_pins dma_converter_0/ready]
  connect_bd_net -net axis_data_fifo_0_m_axis_tdata [get_bd_pins axi_dma_0/s_axis_s2mm_tdata] [get_bd_pins axis_data_fifo_0/m_axis_tdata] [get_bd_pins dma_converter_0/dout]
  connect_bd_net -net axis_data_fifo_0_m_axis_tvalid [get_bd_pins axi_dma_0/s_axis_s2mm_tvalid] [get_bd_pins axis_data_fifo_0/m_axis_tvalid] [get_bd_pins dma_converter_0/valid]
  ...
  connect_bd_net -net cycle_counter_0_number [get_bd_ports number] [get_bd_pins cycle_counter_0/number]
  connect_bd_net -net dma_converter_0_keep [get_bd_pins axi_dma_0/s_axis_s2mm_tkeep] [get_bd_pins dma_converter_0/keep]
  connect_bd_net -net dma_converter_0_last [get_bd_pins axi_dma_0/s_axis_s2mm_tlast] [get_bd_pins cycle_counter_0/last] [get_bd_pins dma_converter_0/last]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins cycle_counter_0/clk] [get_bd_pins dma_converter_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins cycle_counter_0/reset] [get_bd_pins dma_converter_0/reset]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
