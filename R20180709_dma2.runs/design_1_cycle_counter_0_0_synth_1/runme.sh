...
HD_PWD='D:/workspace/R20180709_dma2/R20180709_dma2.runs/design_1_cycle_counter_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_cycle_counter_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_cycle_counter_0_0.tcl
